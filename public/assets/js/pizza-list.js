...
//this function gets our pizza data, transforms it into JSON data that is usable, and runs each one through the printPizza function with the .forEach() method
const getPizzaList = () => {
  fetch('/api/pizzas')
